...
//getting the info frpm the jsonfile
    ...
    document.getElementById("Price").innerHTML = data.data.coin.price; // gets the out printed data from the written data in the conlsole from the jsonfile and converts int to a class wich is later can be printed out on with help of HTML paragraf or class
    ...
    document.getElementById("highest").innerHTML = data.data.coin.allTimeHigh.price; // gets the out printed data from the written data in the conlsole from the jsonfile and converts int to a class wich is later can be printed out on with help of HTML paragraf or class
